...
attributes_of_projects = {'Имя проекта' : ["Введите новое имя проекта", "project_name"],
                          "Описание" : ["Введите новое описание проекта", "decription"],
...
Помогу тебе сохранить твои проекты и информацию о них!
    чтобы начать, пропиши /new_project 
""")
...
/skills - добавить навыки к твоему проекту
...
def text_handler(message):
    ...
    if project in projects:
        ...
        return
    bot.reply_to(message, "я тебя не понял, чтобы посмотреть команды, пропиши /info или /start")
